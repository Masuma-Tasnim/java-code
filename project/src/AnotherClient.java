...
public class AnotherClient extends JFrame implements ActionListener,Runnable{
    JPanel p1;
    JTextField t1;
    JButton b1;
    static JTextArea a1;
    ...
    AnotherClient(){
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/han.png"));
    ...
    public static void main(String[] args){
        AnotherClient two = new AnotherClient();
